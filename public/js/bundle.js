...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2ltYmFkZWViIiwiYSI6ImNrc3UyczlwcDA1MzIydnFjbTFyanhjYXoifQ.KOy3dFopa4nF09iodEABVA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/simbadeeb/cksvneaui0l7317mt7jw4r12z',
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description)).addTo(map); // Extend map bounds to include locations
...
var stripe = Stripe('pk_test_51JVG3NKjApHvGdu4BdNbm0hjGknQ2HP6A4obrJRrPiW7PBKn23M70FWmWdeC9CXEcEGuI3VyAqk8Y8u8hzcavK5V00AnjmH4vN');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            console.log("Processing..."); // 1) Get checkout session from API
